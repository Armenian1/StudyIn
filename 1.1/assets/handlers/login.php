...
if (isset($_POST['name']) && isset($_POST['password'])) {
	...
	$token = makeToken(base64UrlEncode($claim),$client_secret);
	
	echo "<script>";
	echo "$(document).ready(function() {";
	echo "var url ='../../ss_administrator/index.php?request=".$token."'";
	echo "$.ajax({url:url, dataType:'jsonp'}).then(function(data) {";
